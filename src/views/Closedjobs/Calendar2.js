...
import {  NavLink } from 'react-router-dom';
 ...
 class Calender extends Component{
    ...
    <h6> <NavLink to="/Tutioninfo2" className="nav-link text-white px-3" >TUTION INFO</NavLink></h6>
    </li>
    <li className="nav-item px-3 mt-3">
    ...
    <i class="fa fa-calendar fa-2x" aria-hidden="true"></i>
     <h6> <NavLink to="/Calendar2" className="nav-link text-dark bg-white px-3"> CALENDER</NavLink></h6>
    </li>
    <li className="nav-item px-3 mt-3">
